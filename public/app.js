              ...
              <div class="loot-entry">
                <div class="loot-info">
                  ...
                  <div class="loot-player-info" style="margin-top: 2px; display: flex; justify-content: space-between; align-items: baseline;">
                    <div>
                      <span class="loot-player-name" style="color: ${getClassColor(item.character_class || getRosterMemberClass(item.character_name))}; ${item.is_in_roster ? '' : 'text-decoration: line-through; opacity: 0.6;'}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${escHtml(item.character_name || 'Unknown')}</span>
